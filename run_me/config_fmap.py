...
def Get_Configuration(exp_path = '', my_model_type=None, my_type1=None, is_vis=None):
    ...
    config['k2'] = 250 #236 #236#300 #120;#20; #number of eigs for mesh2
    ...
    config['fig_C21'] = os.path.join(exp_path, config['model_type'] + '_C21_fig.pdf')
    config['fig_C21_full'] = os.path.join(exp_path, config['model_type'] + '_C21_full_fig.pdf')
